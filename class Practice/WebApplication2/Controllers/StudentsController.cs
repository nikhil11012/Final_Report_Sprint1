...
namespace WebApplication2.Controllers
{
    public class StudentsController : Controller
    {
        ...
        {
            var applicationDbContext = _context.Students.Include(s => s.AcademicStream).Include(s => s.Parent);
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,StreamId,ParentId")] Student student)
        {
            ...
            ViewData["StreamId"] = new SelectList(_context.AcademicStreams, "Id", "Name", student.StreamId);
