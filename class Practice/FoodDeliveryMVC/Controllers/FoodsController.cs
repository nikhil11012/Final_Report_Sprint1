...
namespace FoodDeliveryMVC.Controllers
{
    ...
    public class FoodsController : Controller
    {
        ...
        {
            var foodDbContext = _context.Foods.Include(f => f.Category);
        ...
        public async Task<IActionResult> Create([Bind("Id,CategoryId,Name,Description,Price")] Food food)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,CategoryId,Name,Description,Price")] Food food)
        {
            if (id != food.Id)
            {
                return NotFound();
