...
namespace WebApplication21.Controllers
{
    public class PharmaciesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,EstablishedOn")] Pharmacy pharmacy)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,EstablishedOn")] Pharmacy pharmacy)
        {
            if (id != pharmacy.Id)
            {
                return NotFound();
